...
<body>
    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            ...
            <div class="logo" style="color: #435EBE;">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Route::is('projets.*','taches.*') ? 'active' : '' }}">
                ...
                <li class="sidebar-item has-sub">
                    <a href="#" class='sidebar-link {{Route::is('profile.*', 'password') ? 'active' : '' }}'>
                        <i class="bi bi-person-circle"></i>
                        <span>Profil</span>
                    </a>
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="{{ route('profile.edit') }}" class="submenu-link">Modifier le Profil</a>
                        </li>
                        <li class="submenu-item">
